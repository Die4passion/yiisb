    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><?= Html::a(Html::img($model->logo),['index/goods','id'=>$model->id]); ?></dt>
                        <dd><?= Html::a(mb_substr($model->goodsIntro->content,0,50),['index/goods', 'id'=>$model->id]); ?></dd>
                        <dd><strong><?= $model->shop_price; ?></strong></dt>
                        <dd><?= Html::a('已有'.$model->stock.'人评价',['index/goods', 'id'=>$model->id])?></dt>
                    </dl>
                </li>
                <?php endforeach; ?>
            </ul>

...
$this->registerJsFile('@web/js/jqzoom-core.js',['depends'=>\yii\web\JqueryAsset::className()]);
...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<?= Html::a('首页', Url::home()); ?><?php foreach ($categories as $category): ?>
                > <?= Html::a($category->name,Url::to(['index/list','id'=>$category->id]))?> <?php endforeach; ?> > <?= $model->name ?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_content fl mt10 ml10">
        <!-- 商品概要信息 start -->
        <div class="summary">
            <h3><strong><?= $model->goodsIntro->content; ?></strong></h3>

            <!-- 图片预览区域 start -->
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?= $model->logo?>" class="jqzoom" rel="gal1" >   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?= $model->logo?>" alt="" style="margin: 2px 4%;max-width: 90%;height: auto;"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?= \yii\helpers\Url::to(['index/add-cart'])?>" method="post" class="choose">
                    <ul>
                        ...
                        <li>
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <input type="hidden" name="name" value="<?= Yii::$app->request->getUrl() ?>">

 ...
 */
class m170619_062617_create_member_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('member', [
            ...
            'auth_key' => $this->string(32)->comment('认证码'),
            'password_hash' => $this->string(100)->notNull()->comment('密码密文'),
            'email' => $this->string(100)->unique()->comment('邮箱'),
            'tel' => $this->char(11)->notNull()->unique()->comment('电话'),
            'last_login_time' => $this->integer()->comment('最后登录时间'),
            'last_login_ip' => $this->integer()->unsigned()->comment('最后登录ip'),
